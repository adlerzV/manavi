...
export const metadata: Metadata = {
  title: "راهنمای خرید اشتراک و سکه با تتر — ماناوی",
  description: "آموزش گام‌به‌گام اتصال کیف پول و خرید اشتراک ویژه یا سکه با تتر در ماناوی.",
};
...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "از فروشگاه، پلن اشتراک ویژه یا پکیج سکه‌ای که می‌خوای رو انتخاب کن. مبلغ به تتر بر اساس نرخ لحظه‌ای نمایش داده می‌شه.",
  },
  {
  ...
  },
  {
    ...
    description:
      "به محض تایید تراکنش روی بلاک‌چین، اشتراک یا سکه‌های خریداری‌شده بدون هیچ کار اضافه‌ای مستقیم به حساب ماناوی‌ت اضافه می‌شه.",
  },
];
    ...
    <main className="relative min-h-screen bg-background text-text-main">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-10 pt-6 text-center sm:pt-10">
        ...
        <h1 className="mx-auto mt-5 max-w-xl text-2xl font-bold leading-relaxed text-text-main sm:text-3xl">
          راهنمای خرید اشتراک و سکه با تتر
        </h1>
        <p className="mx-auto mt-4 max-w-lg text-sm leading-8 text-text-muted">
          ماناوی خرید اشتراک ویژه و سکه رو مستقیم از طریق تتر و بدون نیاز به کارت بانکی یا درگاه واسط ممکن کرده. این راهنما مراحل رو قدم‌به‌قدم نشون می‌ده.
        </p>
      </section>
