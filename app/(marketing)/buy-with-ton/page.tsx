...
export const metadata: Metadata = {
  title: "راهنمای خرید اشتراک و سکه با TON — مناوی",
  description: "آموزش گام‌به‌گام اتصال کیف پول تون و خرید اشتراک ویژه یا سکه در مناوی.",
};

const STEPS = [
  {
    icon: <Wallet size={20} />,
    title: "۱. نصب یک کیف پول تون",
    description:
      "اگر هنوز کیف پول TON نداری، اپلیکیشن Tonkeeper یا هر کیف پول دیگه‌ای که از TON Connect پشتیبانی می‌کنه رو از استور گوشیت نصب کن و یک حساب بساز.",
  },
  {
    icon: <ArrowLeftRight size={20} />,
    title: "۲. اتصال کیف پول به مناوی",
    description:
      "داخل مینی‌اپ مناوی به بخش «فروشگاه» برو. روی دکمه اتصال کیف پول بزن و کیف پولت رو از لیست انتخاب کن؛ تایید اتصال داخل خود اپ کیف پول انجام می‌شه.",
  },
  {
    icon: <CreditCard size={20} />,
    title: "۳. انتخاب پلن اشتراک یا پکیج سکه",
    description:
      "از فروشگاه، پلن اشتراک ویژه یا پکیج سکه‌ای که می‌خوای رو انتخاب کن. مبلغ به TON بر اساس نرخ لحظه‌ای نمایش داده می‌شه.",
  },
  {
    icon: <CheckCircle2 size={20} />,
    title: "۴. تایید تراکنش در کیف پول",
    description:
      "بعد از زدن دکمه پرداخت، اپ کیف پولت باز می‌شه و جزئیات تراکنش رو نشون می‌ده. تراکنش رو تایید کن — تا وقتی روی شبکه تون تایید بشه چند لحظه صبر کن.",
  },
  {
    icon: <ShieldCheck size={20} />,
    title: "۵. فعال‌سازی خودکار",
    description:
      "به محض تایید تراکنش روی بلاک‌چین، اشتراک یا سکه‌های خریداری‌شده بدون هیچ کار اضافه‌ای مستقیم به حساب مناوی‌ت اضافه می‌شه.",
  },
];

export default function BuyWithTonPage() {
    ...
    <main className="relative min-h-screen bg-background text-text-main">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-10 pt-6 text-center sm:pt-10">
        ...
        <h1 className="mx-auto mt-5 max-w-xl text-2xl font-bold leading-relaxed text-text-main sm:text-3xl">
          راهنمای خرید اشتراک و سکه با TON
        </h1>
        <p className="mx-auto mt-4 max-w-lg text-sm leading-8 text-text-muted">
          مناوی خرید اشتراک ویژه و سکه رو مستقیم از طریق کیف پول TON و بدون نیاز به کارت بانکی یا درگاه واسط ممکن کرده. این راهنما مراحل رو قدم‌به‌قدم نشون می‌ده.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-20">
        <div className="rounded-2xl border border-border bg-surface/40 p-6">
          ...
          <ul className="space-y-2 text-sm leading-7 text-text-muted">
            <li>قیمت‌ها به TON بر اساس نرخ لحظه‌ای محاسبه می‌شن و ممکنه با نوسان بازار کمی تغییر کنن.</li>
            <li>تایید تراکنش روی شبکه تون معمولاً چند ثانیه تا چند دقیقه طول می‌کشه.</li>
            <li>اگر بعد از پرداخت موفق، سکه یا اشتراک فعال نشد، چند دقیقه صبر کن و صفحه فروشگاه رو رفرش کن.</li>
